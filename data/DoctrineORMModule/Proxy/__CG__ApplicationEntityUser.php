...
class User extends \Application\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'notifications', 'comments', 'orders', 'messages', 'id', 'email', 'password', 'role', 'phone', 'name', 'address', 'status', 'token', 'dateCreated'];
        }
    ...
    public function setDateCreated($date)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateCreated', [$date]);
